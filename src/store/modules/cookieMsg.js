...
const cookieMsg={
  ...
  mutations:{
    ...
    SET_TOKEN:(state)=>{
      setStore('token','eyJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1MjIyMDE2NzMsInN1YiI6IntcInVpZFwiOjIsXCJzY29wZVwiOlwiQUxMXCJ9IiwiaXNzIjoiTUFMTCJ9.J152KhTUHMBQ6cfu3oi3amM9Vrd5ds0P9V2Hyy9SQIw');
